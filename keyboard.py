...
from config import CHANEL_URL, BOT_URL, DOCUMENT_URL_1, DOCUMENT_URL_2, PUBLIC_SITE_URL, SUPPORT_URL
...
def partner_invite_share_text(user_id: int) -> str:
    lines = [
        "💸 Ускоритель соцсетей — подключайся по моей партнёрской ссылке!",
        "",
