...
CATEGORY_LABELS = {
    ...
    "subscribe_none_or_expired_10d": "нет подписки или просрочена 10+ дней",
...
CUSTOM_PRESETS = [
    ...
    ("get_trial", "get_trial", "🎁 Получить триал — 7 дней", STYLE_SUCCESS),
    ...
    ("r_120", "r_120", "🔥 Успеть забрать 4 месяца", STYLE_SUCCESS),
